...
const Doctors = () => {
  ...
  // ✅ Smarter image URL builder
  const getImageUrl = (img) => {
    if (!img) return "https://via.placeholder.com/150";
    if (img.startsWith("http")) return img;

    const clean = img.replace(/^\/+/, ""); // remove starting slashes
    const base = "https://backend-health-connect.vercel.app";
    ...
    // fallback: assume image is stored inside /uploads
