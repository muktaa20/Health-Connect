...
const Banner = () => {
  return (
    <div className="flex flex-col md:flex-row items-center bg-white min-h-[90vh] pt-24 md:pt-12 lg:pt-8">
      {/* Left Content */}
      <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
        <div className="flex items-center gap-2 w-fit shadow-md px-4 py-2 rounded-2xl mb-3">
        ...
        <div className="flex gap-6 mt-6 font-bold">
