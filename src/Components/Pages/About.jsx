...
const About = () => {
  return (
    <div className="pt-5">
      {/* Hero Section */}
      <section
        className="border border-white-500 rounded-4xl ml-32 mr-32 text-white text-center p-20  bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      <section className="py-16 px-4 grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <section className="text-center py-16  px-4">
        <h2 className="text-2xl font-semibold mb-2">Ready to Connect with Us?</h2>
